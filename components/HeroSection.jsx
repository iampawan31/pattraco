  ...
  return (
    <div className="flex">
      ...
      to-black/5
        ...
        font-extralight"
        />
        <div className="absolute z-40 w-full md:w-fit left-0 md:left-auto flex md:flex-col items-center md:items-end bottom-0 md:bottom-0 md:right-0 bg-white bg-opacity-60 text-gray-800 md:rounded-tl-xl px-4 py-4 md:text-right">
